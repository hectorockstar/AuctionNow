...
function setAuctionCountdown() {
	var dateAuctionCountdown = document.getElementById('h_dateAuctionCountdown') != null ? document.getElementById('h_dateAuctionCountdown').value : '';
	
	if (dateAuctionCountdown != null && dateAuctionCountdown != '') {
