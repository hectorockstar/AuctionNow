...
<div class="panel panel-default">
	<div class="panel-body">
		...
		<div class="container">
			<div class="row well">
				<div class="col-xs-8">
					<h2><s:text name="title.label.formulario.registro.cliente" /></h2>
					<br>
							...
							<div class="form-group">
								<div class="col-sm-9 col-sm-offset-3">
									<div class="checkbox campoValidado">
										<label> <input type="checkbox" name="chkTerminos_condiciones" />
										<s:text name="descripcion.leido.acepto.terminos1" /> 
										<a href="#" data-toggle="modal"	data-target="#terminosDelServicioModal">
